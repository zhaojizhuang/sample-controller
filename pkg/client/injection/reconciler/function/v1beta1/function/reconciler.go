...
import (
	...
	functionv1beta1 "knative.dev/super-controller/pkg/client/listers/function/v1beta1"
)

// Interface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.Function.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.Function. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.Function) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.Function.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.Function. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.Function) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.Function if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1beta1.Function.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1beta1.Function) reconciler.Event
}

// ReadOnlyFinalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.Function if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1beta1.Function.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1beta1.Function) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1beta1.Function) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1beta1.Function resources.
type reconcilerImpl struct {
	...
	Lister functionv1beta1.FunctionLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister functionv1beta1.FunctionLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1beta1.Function, desired *v1beta1.Function) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.FunctionV1beta1().Functions(desired.Namespace)
		...
		updater := r.Client.FunctionV1beta1().Functions(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.Function) (*v1beta1.Function, error) {
	...
	patcher := r.Client.FunctionV1beta1().Functions(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.Function) (*v1beta1.Function, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.Function, reconcileEvent reconciler.Event) (*v1beta1.Function, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
