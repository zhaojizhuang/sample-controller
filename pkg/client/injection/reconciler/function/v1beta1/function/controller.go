...
import (
	...
	function "knative.dev/super-controller/pkg/client/injection/informers/function/v1beta1/function"
)

const (
	defaultControllerAgentName = "function-controller"
	defaultFinalizerName       = "functions.function.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "function.knative.dev.Function"),
	)
