...
type FakeFunctions struct {
	Fake *FakeFunctionV1beta1
	ns   string
}

var functionsResource = schema.GroupVersionResource{Group: "function.knative.dev", Version: "v1beta1", Resource: "functions"}

var functionsKind = schema.GroupVersionKind{Group: "function.knative.dev", Version: "v1beta1", Kind: "Function"}
